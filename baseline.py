...
data = load_data(
    ...
    sentiment=False, news_data_path=None,
...
model = create_model(HISTORY_DAYS, len(FEATURE_COLUMNS), classification=CLASSIFICATION,
...
# Callbacks.
checkpointer = ModelCheckpoint(filepath=f'models/{'baseline_' + CLASSIFICATION_MODEL_NAME}.keras', save_best_only=True, verbose=1)
...
best_model = load_model(f'models/{'baseline_' + CLASSIFICATION_MODEL_NAME}.keras', compile=False)
# Make predictions.
